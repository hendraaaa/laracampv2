                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{route('checkout.store',$camp->id)}}" class="basic-form" method="POST">
                                ...
                                <div class="mb-4">
                                    <label for="exampleInputEmail1" class="form-label {{$errors->has('occupation') ? 'is-invalid' : ''}}">Occupation</label>
                                ...
                                <div class="mb-4">
                                    <label for="exampleInputEmail1" class="form-label {{$errors->has('phone') ? 'is-invalid' : ''}}">phone</label>
                                ...
                                <div class="mb-4">
                                    <label for="exampleInputEmail1" class="form-label {{$errors->has('address') ? 'is-invalid' : ''}}">address</label>
